        ...
        <div class="container">
            <el-row>
                ...
                <el-select v-model="isComplete" placeholder="请选择" style="padding: 10px">
                    <el-option key="bbk" label="计算机科学与技术" value="bbk" ></el-option>
                    <el-option key="xtc" label="电子信息工程" value="xtc"></el-option>
                    <el-option key="s" label="网络工程" value="xtc"></el-option>
                </el-select>
                ...
                <el-select v-model="isComplete" placeholder="请选择" style="padding: 10px">
                    ...
                    <el-option key="e" label="3" value="xtc"></el-option>
                    <el-option key="a" label="4" value="xtc"></el-option>
                </el-select>

                是否被选中
                <el-select v-model="isComplete" placeholder="请选择" style="padding: 10px">
                    <el-option key="bbk" label="是" value="bbk" ></el-option>
                    <el-option key="xtc" label="否" value="xtc"></el-option>
                </el-select>

            </el-row>
            <el-row>
                <el-col :span="4" v-for="item in students" style="padding: 8px">
                    <el-card class="box-card" style="height: 280px" >
                        ...
                        <div  class="text item" v-if="item.selected == 0">
                            ...
                            <el-button type="primary" @click="addVisible=true" v-if="item.selected == 0">加入</el-button>
                        </div>
